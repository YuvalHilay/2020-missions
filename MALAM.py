...
if(num>0 and num<10): #check if the number have one digit
    print("OK")
elif(num>=10 and num <=99):### if number has 2 digits
 if((num%10)%3 != (num//10%10)%3):#calc the number if OK
   print("OK")
 else:
     print("ERROR")
...
if((k//10**numlen-1)%3 != ((k//(10**numlen-2))%10)%3 != ((k//(10**numlen-1))%10))%3:#### check for the three numbers first of an %2 number
